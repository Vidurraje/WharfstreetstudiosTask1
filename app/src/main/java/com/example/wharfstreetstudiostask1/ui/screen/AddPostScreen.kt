...
@Composable
fun AddPostScreen(navController: NavController, viewModel: PostViewModel) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                ...
                enabled = postTitle.isNotBlank() && description.isNotBlank() && author.isNotBlank(),
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
                shape = RoundedCornerShape(8.dp),
                ...
                Text("SUBMIT", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold)
            }
        }
    }
}
